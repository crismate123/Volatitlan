...
# ==========================================
# Interruptor de la pestaña "Selección de modelos". Está oculta para la
# presentación del proyecto; para volver a mostrarla basta con cambiarlo a True.
# Mientras está en False, su contenido tampoco se ejecuta (no se estiman los
# GARCH/EGARCH en cada carga), pero todo el código se conserva intacto.
MOSTRAR_SELECCION_MODELOS = False

nombres_pestanas = ["Pronóstico", "Dashboard"]
if MOSTRAR_SELECCION_MODELOS:
    nombres_pestanas.append("Selección de modelos")
nombres_pestanas.append("Acerca del Autor")
pestanas = st.tabs(nombres_pestanas)
tab1, tab2, tab4 = pestanas[0], pestanas[1], pestanas[-1]
tab3 = pestanas[2] if MOSTRAR_SELECCION_MODELOS else None
